<?php
	...
	//Define a constant for the task file (tasks.json)
	define("TASKS_FILE", "tasks.json");

	//create a function to load task from the task.json file
	...
	//cerate a function to save tasks (input value) to the tasks.json 
...
<body>
    <div class="container">
        <div class="task-card">
            ...
            <!-- TODO: Loop through tasks array and display each task with a toggle and delete 
			option -->
